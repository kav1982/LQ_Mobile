Shader "MMN/CH/Eye_Emotion" {
	Properties {
		_EyeballTexture ("Eyeball", 2D) = "white" {}
		_Alpha ("Override Alpha", Range(0, 1)) = 1
		_EyeballTextureRowNum ("Eyeball Texture Total Row #", Float) = 1
		_EyeballTextureColNum ("Eyeball Texture Total Column #", Float) = 1
		_EyeballIndexFromOne ("Eyeball Texture # to be used (row major)", Float) = 1
		_LeftEyeball_TS ("Left Eyeball Position and Scale", Vector) = (0,0,1,1)
		_RightEyeball_TS ("Right Eyeball Position and Scale", Vector) = (0,0,1,1)
		_EyePositionOffset ("Eye UV Position Offset", Vector) = (0,0,0,0)
		_EyeRotationOffset ("Eye UV Rotation Offset", Float) = 0
		...
		[Header(Side Clip)] [Enum(None, 0, Left, 1, Right, 2)] _SideClipHide ("숨길 방향", Float) = 0
	...
	//CustomEditor "MM.Client.Editor.ShaderGUI.CharacterEyeEmotionShaderGUI"
}